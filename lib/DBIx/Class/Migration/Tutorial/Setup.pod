package DBIx::Class::Migration::Tutorial::Setup;
...
where you like to store project files, and proceed.
...
From your appliation home directory (the directory that contains your
...
If your tests pass, that' great you've completed the first part of the tutorial!
