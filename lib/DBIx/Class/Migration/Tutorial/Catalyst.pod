...
For example, something in C<script/my-dbic-migration>
    ...
    DBIx::Class::Migration::Script
      ->run_with_options(
        sandbox_type => DBIx::Class::Migration::Script::SANDBOX_MYSQL,
        schema => MusicBase::Web->model('Schema')->schema);
...
If you looked carefully, you can see we are also specifying the C<sandbox_type>
in this example.  You'd do something like this if you wanted to use a sandbox
other than the default sqlite.
