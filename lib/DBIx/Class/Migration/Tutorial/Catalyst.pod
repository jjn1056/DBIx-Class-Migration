...
server you are eventually deploying to).  Additionally, and just to show you
some of the features, we will create two database 'slave' replicants using
MySQL native replication.  If you plan to use replication in production, as
many of you do, I highly recommend running tests in a replicated setup, to make
sure your code is replication safe.
