...
DBIx::Class::Migration::Script::Help - Summary of the CLI help documentation
...
=head1 COMMANDS
  ...
  examples            : More examples of common usage

=head1 OPTIONS

  includes (I,lib)    : Adds the listed paths to @INC.
