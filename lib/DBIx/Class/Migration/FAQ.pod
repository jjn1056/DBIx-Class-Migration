...
not convince your fellow programs (yet :) ), here's one way to still use this
migrations and fixtures system.

You use L<DBIx::Class::Schema::Loader> in a namespace for your application,
like:
...
You'd put that in C<lib/MyApp::Schema> along with your other application code.
...
discussed in the tutorial, you are not providing a good schema_class value.
