...
B<UPDATE>:  You really should not be seeing this anymore, if you are, and you're
...
If L<Test::Postgresql58> fails to install, you are probably running with
...
=head1 How to run a Migration Script before changing the Schema
...
=head1 How do I specify the character set for a database or table?
...
L<DBIx::Class::Migration>. Remember that the default character set of the whole
...
the DBIC result source:
  ...
  sub sqlt_deploy_hook {
    ...
    $sqlt_table->options({'DEFAULT CHARACTER SET' => 'utf8'});
  }
...
find a way to offer a patch to L<Test::Postgresql58>, although this seems to be
